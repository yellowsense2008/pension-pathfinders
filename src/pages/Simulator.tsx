  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <div className="gradient-primary px-5 pb-5 pt-8">
        <h1 className="mb-1 font-display text-xl font-bold text-primary-foreground">Retirement Simulator</h1>
        <p className="text-xs text-primary-foreground/70">See how your money grows over time</p>
      </div>
      ...
      <div className="mx-auto max-w-md px-5 mt-4 space-y-4">
        ...
        <div className="game-card space-y-4 animate-fade-in">
          ...
          <div>
            <label className="flex items-center justify-between text-sm font-semibold text-foreground">
              ...
              <span className="font-display text-primary">{years} years</span>
            </label>
        ...
        <div className="game-card animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          <h3 className="mb-3 font-display text-sm font-bold text-foreground">Growth Projection</h3>
          <div className="h-52">
        ...
        >
          ...
          {simulated ? 'Goal Saved! ✓' : 'Set This as My Goal'}
